      ...
      <Grid col={12} row={2} cgap={2} rgap={2} margin={20} padding={2}>
        <StArticle>
          ...
          <p>
            ...
            테크놀로지, 업계 최고 수준의 전력 효율을1 자랑하는 M1은 Mac의 성능을
        ...
        <StArticle>
          <h2>GPU</h2>
          <p>
            8코어 GPU 아름다움을 완성하는 야수성. M1에 탑재된 8코어 GPU는
            Apple이 제작한 그래픽 프로세서 중 단연코 가장 앞선 성능을
            자랑합니다. 세상에서 가장 빠른 PC용 통합 그래픽을 제공하는7 이 칩은
            무려 5배나 빨라진 말도 안 되는 스피드의 그래픽 성능을 보여주죠.
        ...
        <StArticle>
          <h2>macOS Big Sur</h2>
          <p>
            M1에서 빛나는 macOS Big Sur의 강력함. M1 칩의 잠재력을 끌어내도록
            개발된 macOS Big Sur가 Mac에 대대적인 성능 향상을 비롯한 다양한
            혜택을 선사합니다. 강력하게 업데이트된 앱, 아름다운 새 디자인,
            업계를 선도하는 개인 정보 보호 기능과 동급 최고의 보안성까지.
            Apple의 최첨단 하드웨어에서 실행되는 최강의 소프트웨어죠.
        ...
        <StArticle>
          ...
          <p>
            ...
            빠르게 실행되죠. 물론 가장 사용량이 많은 앱들도 이 강력한 파워에
            힘입어 아주 매끄럽게 구동된답니다.
        ...
        <StArticle>
          ...
          <p>
            ...
            앱도 모두 구동할 수 있습니다. 게다가 이제부터는 즐겨 사용하는
            iPhone과 iPad 앱까지 macOS Big Sur에서 그대로 사용 가능합니다. 사상
            최대의 앱 컬렉션을 이렇게 Mac에서 전부 만나볼 수 있게 된 거죠.
