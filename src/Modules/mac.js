  ...
  main: [
    {
      ...
      modalTrigger: 'M1이 엄청난 속도를 내는 비결 알아보기',
      image: 'mac_cpu.png',
      gridArea: '1/1/1/13',
    },
    {
      ...
      modalTrigger: 'M1이 그래픽 성능을 높여주는 비결 알아보기',
      video: 'mac_gpu.mp4',
      gridArea: '2/1/2/13',
    },
    {
      ...
      modalTrigger: 'M1이 ML 성능을 높여주는 비결 알아보기',
      image: 'mac_ml.png',
      gridArea: '3/1/3/13',
    },
    {
      header: 'macOS Big Sur',
    ...
    },
    {
      ...
      image: 'mac_app_collection.png',
      gridArea: '5/7/5/13',
    },
    {
      header: '열 효율',
      headline: ['액티브 쿨링으로 빠른 처리 속도를 유지합니다.'],
      video: 'mac_cooling.mp4',
      gridArea: '6/1/6/5',
    },
    {
      header: '한나절은 너끈한 배터리 성능',
    ...
    },
    {
      ...
      image: ['mac_memory.jpg', 'mac_memory_icon.png'],
      gridArea: '7/1/7/5',
    },
    {
      header: 'SSD 저장 장치',
    ...
    },
    {
      ...
      modalTrigger: 'M1이 개인 정보를 보호하는 비결 알아보기',
      image: 'mac_security.png',
      gridArea: '7/9/7/13',
    },
  ],
  retina: [
    {
      header: '밝기',
      headline: '500 니트 밝기',
      image: 'mac_backlight.png',
    },
    {
      header: '넓은 색영역(P3)',
      headline: '25% 더 풍부한 색상(sRGB 대비)',
      image: 'mac_colors.jpg',
    },
    {
      header: 'True Tone 기술',
      headline: '주변 조명에 맞춰 자동 조정되는 화면 밝기.',
      image: 'mac_truetone.png',
    },
  ],
  facetime: [
    {
      header: 'FaceTime HD 카메라',
      paragraph:
  ...
  connectivity: [
    {
      ...
      image: 'mac_wifi_icon.png',
    },
    {
      header: 'Thunderbolt/USB 4',
      paragraph:
